...
module.exports = {
  ...
  userName: function(recipientId, callback){
    ...
    var url=  'https://graph.facebook.com/v2.6/me/messages/'+recipientId+'?fields=first_name,last_name,profile_pic,locale,timezone,gender&access_token='+access_token;
